...
<body>
	...
	<section>
		<div id="section">
			<div id="container">
				<h1 style="margin-top: 20px; margin-bottom: 20px; margin-left: 100px;">자유게시판관리</h1>
					...
					<tbody>
						<c:forEach items="${boardList }" var="b">
							<tr>
								...
								<td><button onclick="detail(${b.b_no}, ${pageNo })" class="primary-btn order-submit" style="padding: 7px 12px; background-color: #F5D0A9;">상세보기</button></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
