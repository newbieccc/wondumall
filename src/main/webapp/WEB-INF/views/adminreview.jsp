	...
	<section>
		<div id="section">
			<div id="container">
				...
				<form action="/wondumall/admin/review.do?pageNo=${pageNo }" style="display: block; margin: 0 auto; text-align: center; margin-bottom: 20px;">
...
function linkPage(pageNo) {
	location.href = "/wondumall/admin/review.do?pageNo=" + pageNo;
}
function rdel(r_no){
	if (confirm("삭제하시겠습니까?")){
		location.href = "/wondumall/admin/rdel/" + r_no;
	} else {
...
function rrpr(r_no){
	if (confirm("복구하시겠습니까?")){
		location.href = "/wondumall/admin/rrpr/" + r_no;
	} else {
...
function rcompledel(r_no){
	if (confirm("삭제하면 복구할 수 없습니다. 정말로 삭제하시겠습니까?")){
		location.href = "/wondumall/admin/rcompledel/" + r_no;
	} else {
