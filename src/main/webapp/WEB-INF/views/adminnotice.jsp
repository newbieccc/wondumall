	...
	<section>
		<div id="section">
			<div id="container">
				...
				<form action="/wondumall/admin/notice.do?pageNo=${pageNo }" style="display: block; margin: 0 auto; text-align: center; margin-bottom: 20px;">
...
function linkPage(pageNo) {
	location.href = "/wondumall/admin/notice.do?pageNo=" + pageNo;
}
function noticecomdel(n_no){
	if (confirm("삭제하면 복구할 수 없습니다. 정말로 삭제하시겠습니까?")){
		location.href = "/wondumall/admin/noticecomdel/" + n_no;
	} else {
		
	}	
}
function noticedetail(n_no, pageNo){
	location.href = "/wondumall/noticeDetail.do?n_no=" + n_no + "&pageNo=" + pageNo;
}
</script>
</body>
</html>